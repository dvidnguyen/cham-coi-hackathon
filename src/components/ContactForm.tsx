        ...
        >
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <a
                href="https://facebook.com/chamcoi"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-xs text-stone-400 hover:text-white transition-colors duration-300 w-fit"
              >
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/40">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
                <span>facebook.com/chamcoi</span>
              </a>
              <a
                href="https://instagram.com/chamcoi.heritage"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-xs text-stone-400 hover:text-white transition-colors duration-300 w-fit"
              >
                ...
                <span>@chamcoi.heritage</span>
              </a>
              <a
                href="mailto:lienhe@chamcoi.vn"
                className="flex items-center gap-3 text-xs text-stone-400 hover:text-white transition-colors duration-300 w-fit"
              >
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/40">
